...
This email was sent from the TalNXT website contact form.`;
    ...
    const mailtoLink = `mailto:info@talnxt.com?subject=${encodeURIComponent(subject)}&body=${encodeURIComponent(body)}`;
    ...
    try {
        ...
        setTimeout(() => {
            ...
            formMessage.innerHTML = '✓ Thank you! Your email client should open. If it didn\'t, please email us directly at <a href="mailto:info@talnxt.com" style="color: var(--primary); text-decoration: underline;">info@talnxt.com</a>';
        ...
        submitText.textContent = 'Submit Requirement';
        submitSpinner.classList.add('d-none');
        formMessage.innerHTML = `Email client not available. Please send an email to <strong>info@talnxt.com</strong> with the following details:<br><br>
